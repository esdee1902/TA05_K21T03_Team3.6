	...
	public ChangeNameSetting() {
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent arg0) {
				int result = JOptionPane.showConfirmDialog(ChangeNameSetting.this, "Exit?");
